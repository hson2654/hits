...
#### bart.htb
  ffuf exclude response length to scan dir; curl to post data to service to signup user; use burp post payload CMD page;download nc and get a shell;swtich userin in windos, net use
